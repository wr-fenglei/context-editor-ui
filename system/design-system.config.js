(() => {
  ...
  const renderFoundationsPage = () => {
    ...
    root.innerHTML = `
      ...
      <section class="review-section" id="icons" data-od-id="foundation-icons"><div class="section-head"><h2>图标库</h2><p>细线轮廓与开放留白, 常用图标以 16 像素显示, 随主题和操作状态切换颜色</p></div><div class="icon-catalog" id="icon-catalog"></div><div class="icon-library-links"><a href="assets/icons/atlas.png?v=thin-icons-1" download="context-editor-ui-icons.png">下载图标图集</a><a href="assets/icons/atlas.json?v=thin-icons-1" download="context-editor-ui-icons.json">下载切图坐标</a></div></section>
